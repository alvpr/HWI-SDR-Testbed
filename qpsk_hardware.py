...
class qpsk_hardware(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "qpsk_hardware", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("qpsk_hardware")
        ...
        self.settings = Qt.QSettings("GNU Radio", "qpsk_hardware")
        ...
        self.snr = snr = 50
        self.pnorm = pnorm = 1
        self.const_iq = const_iq = digital.constellation_calcdist([0.7071 + 0.6396j,   -0.7071 + 0.5367j,  -0.7071 - 0.6396j, 0.7071 - 0.5367j], [0,1,2,3],
        1, 1, digital.constellation.NO_NORMALIZATION).base()
        self.sps = sps = 4
        self.sigma2 = sigma2 = pnorm/(10**(snr/10))
        self.pconst_iq = pconst_iq = const_iq.points()
        ...
        self.const = const = digital.constellation_calcdist([(d + d*1j ), (-d + d*1j), (-d - d*1j), (+d - d*1j)], [0,1,2,3],
        1, 1, digital.constellation.NO_NORMALIZATION).base()
        self.arity = arity = 4
        ...
        self.digital_diff_decoder_bb_0_0_0_0 = digital.diff_decoder_bb(4)
        ...
        self.demonstrator_crc32_check_0 = demonstrator.crc32_check(1000, 400, 1)
        ...
        self.analog_agc_xx_0_0 = analog.agc_cc(1e-4, mod_avg_iq*0.965, 1.0)
    ...
    def set_mod_avg_iq(self, mod_avg_iq):
        ...
        self.analog_agc_xx_0_0.set_reference(self.mod_avg_iq*0.965)
...
def main(top_block_cls=qpsk_hardware, options=None):
