...
class qam64_hardware(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "qam64_hardware", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("qam64_hardware")
        ...
        self.settings = Qt.QSettings("GNU Radio", "qam64_hardware")
        ...
        self.const_iq = const_iq = digital.constellation_calcdist(pconst_iq, [i for i in range(64)],
        1, 1, digital.constellation.NO_NORMALIZATION).base()
        self.const = const = digital.constellation_calcdist(pconst, [i for i in range(64)],
        1, 1, digital.constellation.NO_NORMALIZATION).base()
        self.arity = arity = 4
        ...
        self.digital_diff_decoder_bb_0_0_0_0 = digital.diff_decoder_bb(64)
        ...
        self.analog_agc_xx_0_0 = analog.agc_cc(1e-4, mod_avg_iq*0.985, 1.0)
    ...
    def set_mod_avg_iq(self, mod_avg_iq):
        ...
        self.analog_agc_xx_0_0.set_reference(self.mod_avg_iq*0.985)
...
def main(top_block_cls=qam64_hardware, options=None):
